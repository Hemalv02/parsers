"""
Office Math Markup Language (OMML) → LaTeX converter.

Vendored from docling (MIT license, github.com/DS4SD/docling),
which itself adapted this from github.com/xiilei/dwml (MIT).

Original docling path: docling/backend/docx/latex/omml.py
Vendored on 2026-05-15 to drop the full docling dependency (which pulls
in PyTorch, transformers, and IBM layout models) — we only need this
self-contained 733-line OMML → LaTeX converter.
"""
